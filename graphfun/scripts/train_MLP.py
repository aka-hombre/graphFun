...
plt.savefig('graphfun/outputs/MLP_output/loss.png', dpi=300)

#-----
#   Writing data to .csv and making log
#-----

df.to_csv('graphfun/outputs/MLP_output/stats.csv')

with open('graphfun/outputs/MLP_output/log.txt', 'w', encoding='utf-8') as f:
    f.write(log_str)
...
np.savez('graphfun/outputs/MLP_output/preds_targets.npz',
         preds=all_preds,
         targets=all_targets)
